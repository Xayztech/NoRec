...
local ConfigurationFileName = "Tredict-Invictus-Exploit-By-Xatanicvxii.json"
...
ScreenGuiPanel.Name = "TredictXata"
...
pcall(function()
    ...
    titleHeaderPanel.Text = "🌐 Tredict Invictus"
            ...
            if isFlingOnRsPanel then
                if hrpFlgRsPanel then
                    if not flingBavInstPanel then
                        ...
                        flingBavInstPanel.Name = "XataFling"
    ...
    local function GetAnchorSetupLogicPanel()
        pcall(function()
            ...
            if not isValAncPanel then
                ...
                AnchorPartLogicPanel.Name = "XataAnchor"
    ...
    ServiceRun.Heartbeat:Connect(function()
        pcall(function()
            ...
            if StateData.ForceField then
                if not charHbPanel:FindFirstChild("XataFF") then
                    local ffNHbPanel = Instance.new("ForceField")
                    ffNHbPanel.Name = "XataFF"
                    ffNHbPanel.Visible = true
                    ffNHbPanel.Parent = charHbPanel
                end
            end
            if not StateData.ForceField then
                if charHbPanel:FindFirstChild("XataFF") then 
                    charHbPanel:FindFirstChild("XataFF"):Destroy() 
                end
            end
            ...
            if offAllHbPanel then
                ...
                local fAncHbPanel = ServiceWorkspace:FindFirstChild("XataAnchor")
                if fAncHbPanel then
